package com.gysignalstudio.blackswan.data.model
...
// Separate map layer for aggregate attack days by Russian region. This is
// intentionally not a Room entity: it is a compact, read-only map overlay.
@com.squareup.moshi.JsonClass(generateAdapter = true)
data class RegionAttackTotalDate(
    val date: String,
    val targetCount: Int,
    val objects: List<String>,
    val citationNumbers: List<Int>,
    val sourceRows: List<Int>
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class RegionAttackTotal(
    val regionId: String,
    val regionNameUk: String,
    ...
    val attackCount: Int,
    val targetCount: Int,
    val dates: List<RegionAttackTotalDate>
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class RegionAttackTotalsSnapshot(
    ...
    val sourceUrl: String,
    val metric: String,
    val metricDescriptionUk: String,
    val metricDescriptionEn: String,
    val regionCount: Int,
    val attackDayCount: Int,
    val targetRowCount: Int,
    val skippedRowsWithoutRussianRegion: Int,
    val regions: List<RegionAttackTotal>
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class FuelRestrictionRegion(
    val regionId: String,
    val regionNameUk: String,
    val regionNameEn: String,
    val iso: String,
    ...
    val statusUk: String,
    val statusEn: String,
    val gasolineLimitLiters: Double?,
    val dieselLimitLiters: Double?,
    val coverageUk: String,
    val coverageEn: String,
    val restrictionUk: String,
    val restrictionEn: String,
    val sourceUrl: String
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class FuelRestrictionsSnapshot(
    val schemaVersion: Int,
    val datasetId: String,
    val generatedAt: String,
    val asOf: String,
    ...
    val metricDescriptionEn: String,
    val regionCount: Int,
    val regions: List<FuelRestrictionRegion>
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class RegionalBudgetStress(
    val regionId: String,
    val regionNameUk: String,
    val regionNameEn: String,
    val iso: String,
    ...
    val statusUk: String,
    val statusEn: String,
    val deficitMillionRub: Double?,
    val deficitPercentRevenue: Double,
    val ownRevenueBillionRub: Double?,
    val publicDebtJuneBillionRub: Double?,
    val publicDebtJanuaryBillionRub: Double?,
    val debtChangePercent: Double?,
    val descriptionUk: String,
    val descriptionEn: String,
    val budgetSourceUrl: String,
    val debtSourceUrl: String
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class RegionalBudgetStressSnapshot(
    val schemaVersion: Int,
    val datasetId: String,
    val generatedAt: String,
    val asOf: String,
    ...
    val metricDescriptionEn: String,
    val regionCount: Int,
    val regions: List<RegionalBudgetStress>
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class SpecialOperationMetric(
    val labelUk: String,
    val labelEn: String,
    val valueUk: String,
...
@com.squareup.moshi.JsonClass(generateAdapter = true)
data class SpecialOperationEntry(
    val id: String,
    val titleUk: String,
    val titleEn: String,
    val dateLabelUk: String,
    val dateLabelEn: String,
    val targetUk: String,
    val targetEn: String,
    val impactUk: String,
    val impactEn: String,
    val metrics: List<SpecialOperationMetric> = emptyList(),
    val detailsUk: List<String> = emptyList(),
    val detailsEn: List<String> = emptyList(),
    val sourceUrls: List<String> = emptyList()
)

@com.squareup.moshi.JsonClass(generateAdapter = true)
data class SpecialOperationsSnapshot(
    val schemaVersion: Int,
    val datasetId: String,
    val generatedAt: String,
    val descriptionUk: String,
...
object SampleOsintData {
    val sources = listOf(
        ...
        SourceEntity(
            sourceId = "source_sbs_grouping_live",
            sourceName = "SBS Grouping Dashboard",
            publisher = "Unmanned Systems Forces of Ukraine",
            sourceType = "OFFICIAL_DASHBOARD",
            country = "Ukraine",
            language = "uk",
            reliabilityScore = 5,
            lastChecked = "2026-07-15",
            usedInRecordsCount = 2,
            sourceDescription = "Official SBS operational dashboard and monthly reporting hub.",
            allowedUse = "Official public reference.",
            reliabilityNote = "Primary official source for SBS operational summaries.",
            sourceUrl = "https://sbs-group.army/subdivision/usf_grouping/?period=monthly_7"
        ),
        SourceEntity(
            sourceId = "source_slovoidilo_shadowfleet_2026_07_15",
            sourceName = "Slovo i Dilo report on 20 shadow fleet vessels",
            publisher = "Slovo i Dilo",
            ...
            sourceDescription = "Media report citing SBS commander details on the Black Sea phase of operation MoLoCHKa.",
            allowedUse = "Public citation with attribution.",
            reliabilityNote = "Useful secondary source tied to official SBS attribution.",
            sourceUrl = "https://www.slovoidilo.ua/2026/07/15/novyna/bezpeka/sbs-urazyly-shhe-20-tinovyx-tankeriv-rf-chornomu-mori"
        ),
        SourceEntity(
            sourceId = "source_armyinform_shadowfleet_2026_07_09",
            sourceName = "ArmyInform report on Azov shadow fleet strikes",
            publisher = "ArmyInform",
            ...
            lastChecked = "2026-07-15",
            usedInRecordsCount = 1,
            sourceDescription = "Official military media reporting on SBS strikes against shadow fleet vessels in the Sea of Azov.",
            allowedUse = "Public citation with attribution.",
            reliabilityNote = "Official military media source with direct SBS framing.",
            sourceUrl = "https://armyinform.com.ua/2026/07/09/syly-oborony-vrazyly-14-suden-tinovogo-flotu-rf-v-azovskomu-mori/"
        ),
        SourceEntity(
            sourceId = "source_lb_shadowfleet_2026_07_15",
            sourceName = "LB.ua report on 136 shadow fleet vessels hit",
            publisher = "LB.ua",
            sourceType = "MEDIA_REPORT",
            country = "Ukraine",
            language = "uk",
            ...
            lastChecked = "2026-07-15",
            usedInRecordsCount = 2,
            sourceDescription = "Media report summarizing cumulative SBS claims for operation MoLoCHKa across the Azov and Black Sea phases.",
            allowedUse = "Public citation with attribution.",
            reliabilityNote = "Secondary corroboration of aggregate totals.",
            sourceUrl = "https://lb.ua/society/2026/07/15/675707_sbs_urazili_20_pershih_tankeriv.html"
        ),
        SourceEntity(
            sourceId = "source_wiki_uav_strikes_2022_2025",
            sourceName = "Ukrainian Wikipedia UAV strikes table, 2022-2025",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            reliabilityScore = 2,
            lastChecked = "2026-07-15",
            usedInRecordsCount = 544,
            sourceDescription = "Discovery snapshot of all attack rows and citation notes from the linked Wikipedia article.",
            allowedUse = "Discovery and traceability only; verify against the cited note before treating as confirmed.",
            reliabilityNote = "Convenient index of public references, not a primary confirmation source.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%9F%D0%B5%D1%80%D0%B5%D0%BB%D1%96%D0%BA_%D0%B0%D1%82%D0%B0%D0%BA_%D0%91%D0%BF%D0%9B%D0%90_%D0%BF%D0%BE_%D1%80%D0%BE%D1%81%D1%96%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D1%85_%D1%86%D1%96%D0%BB%D1%8F%D1%85_(2022-2025)"
        ),
        SourceEntity(
            sourceId = "source_wiki_uav_strikes_2026",
            sourceName = "Ukrainian Wikipedia UAV strikes table, 2026",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            reliabilityScore = 2,
            lastChecked = "2026-07-15",
            usedInRecordsCount = 396,
            sourceDescription = "Discovery snapshot of all 2026 attack rows and citation notes from the linked Wikipedia article.",
            allowedUse = "Discovery and traceability only; verify against the cited note before treating as confirmed.",
            reliabilityNote = "Convenient index of public references, not a primary confirmation source.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%9F%D0%B5%D1%80%D0%B5%D0%BB%D1%96%D0%BA_%D0%B0%D1%82%D0%B0%D0%BA_%D0%91%D0%BF%D0%9B%D0%90_%D0%BF%D0%BE_%D1%80%D0%BE%D1%81%D1%96%D0%B9%D1%81%D1%8C%D0%BA%D0%B8%D1%85_%D1%86%D1%96%D0%BB%D1%8F%D1%85_(2026)"
        ),
        SourceEntity(
            sourceId = "source_wiki_special_events_crimean_bridge_2022",
            sourceName = "Wikipedia: Crimean Bridge explosion (2022)",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            ...
            lastChecked = "2026-07-15",
            usedInRecordsCount = 1,
            sourceDescription = "Narrative event source for the first Crimean Bridge strike.",
            allowedUse = "Discovery and traceability only.",
            reliabilityNote = "Verify against the cited notes before treating as confirmed.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%92%D0%B8%D0%B1%D1%83%D1%85_%D0%BD%D0%B0_%D0%9A%D1%80%D0%B8%D0%BC%D1%81%D1%8C%D0%BA%D0%BE%D0%BC%D1%83_%D0%BC%D0%BE%D1%81%D1%82%D1%83_%282022%29"
        ),
        SourceEntity(
            sourceId = "source_wiki_special_events_crimean_bridge_2023",
            sourceName = "Wikipedia: Crimean Bridge explosion (2023)",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            ...
            lastChecked = "2026-07-15",
            usedInRecordsCount = 1,
            sourceDescription = "Narrative event source for the second Crimean Bridge strike.",
            allowedUse = "Discovery and traceability only.",
            reliabilityNote = "Verify against the cited notes before treating as confirmed.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%92%D0%B8%D0%B1%D1%83%D1%85_%D0%BD%D0%B0_%D0%9A%D1%80%D0%B8%D0%BC%D1%81%D1%8C%D0%BA%D0%BE%D0%BC%D1%83_%D0%BC%D0%BE%D1%81%D1%82%D1%83_%282023%29"
        ),
        SourceEntity(
            sourceId = "source_wiki_special_events_crimean_bridge_2025",
            sourceName = "Wikipedia: Crimean Bridge explosion (2025)",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            ...
            lastChecked = "2026-07-15",
            usedInRecordsCount = 1,
            sourceDescription = "Narrative event source for the third Crimean Bridge strike.",
            allowedUse = "Discovery and traceability only.",
            reliabilityNote = "Verify against the cited notes before treating as confirmed.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%92%D0%B8%D0%B1%D1%83%D1%85_%D0%BD%D0%B0_%D0%9A%D1%80%D0%B8%D0%BC%D1%81%D1%8C%D0%BA%D0%BE%D0%BC%D1%83_%D0%BC%D0%BE%D1%81%D1%82%D1%83_%282025%29"
        ),
        SourceEntity(
            sourceId = "source_wiki_special_events_a50_azov_2024",
            sourceName = "Wikipedia: A-50 over the Sea of Azov (2024)",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            ...
            lastChecked = "2026-07-15",
            usedInRecordsCount = 1,
            sourceDescription = "Narrative event source for the A-50U and Il-22M losses.",
            allowedUse = "Discovery and traceability only.",
            reliabilityNote = "Verify against the cited notes before treating as confirmed.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%97%D0%BD%D0%B8%D1%89%D0%B5%D0%BD%D0%BD%D1%8F_%D0%90-50_%D0%BD%D0%B0%D0%B4_%D0%90%D0%B7%D0%BE%D0%B2%D1%81%D1%8C%D0%BA%D0%B8%D0%BC_%D0%BC%D0%BE%D1%80%D0%B5%D0%BC_%28%D1%81%D1%96%D1%87%D0%B5%D0%BD%D1%8C_2024%29"
        ),
        SourceEntity(
            sourceId = "source_wiki_special_events_russian_bridges_2025",
            sourceName = "Wikipedia: bridges destroyed in Russia (June 2025)",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            ...
            lastChecked = "2026-07-15",
            usedInRecordsCount = 2,
            sourceDescription = "Narrative event source for the two bridge destructions in Bryansk and Kursk oblasts.",
            allowedUse = "Discovery and traceability only.",
            reliabilityNote = "Verify against the cited notes before treating as confirmed.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%9F%D1%96%D0%B4%D1%80%D0%B8%D0%B2%D0%B8_%D0%BC%D0%BE%D1%81%D1%82%D1%96%D0%B2_%D1%83_%D0%A0%D0%BE%D1%81%D1%96%D1%97_%28%D1%87%D0%B5%D1%80%D0%B2%D0%B5%D0%BD%D1%8C_2025%29"
        ),
        SourceEntity(
            sourceId = "source_wiki_special_events_operation_spiderweb_2025",
            sourceName = "Wikipedia: Operation Spiderweb",
            publisher = "Ukrainian Wikipedia",
            sourceType = "DISCOVERY_ONLY",
            country = "Ukraine",
            language = "uk",
            reliabilityScore = 2,
            lastChecked = "2026-07-15",
            usedInRecordsCount = 6,
            sourceDescription = "Narrative source for the five targeted airfields and aircraft loss ranges in Operation Spiderweb.",
            allowedUse = "Discovery and traceability only.",
            reliabilityNote = "Keep confirmed and claimed figures separate; verify against cited notes.",
            sourceUrl = "https://uk.wikipedia.org/wiki/%D0%9E%D0%BF%D0%B5%D1%80%D0%B0%D1%86%D1%96%D1%8F_%C2%AB%D0%9F%D0%B0%D0%B2%D1%83%D1%82%D0%B8%D0%BD%D0%B0%C2%BB"
        )
    )
